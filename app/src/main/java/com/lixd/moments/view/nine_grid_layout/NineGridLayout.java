...
public abstract class NineGridLayout extends ViewGroup {
    ...
    private void refresh() {
        ...
        if (size == 1) {
            ...
            imageView.setTransitionName(getContext().getString(R.string.preview_transition_name) + "_0");
        ...
        for (int i = 0; i < size; i++) {
            ...
            imageView.setTransitionName(getContext().getString(R.string.preview_transition_name) + "_" + i);
        }
    }
